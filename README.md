...
Por el momento, esta es la interfaz, hay botones que llevan a otras páginas y otros que no se les ha añadido funcionalidad. Es importante resaltar que al principio se debe indicar la ruta del archivo .py que tiene el modulo de Flet para poder importarlo. 
``` python
# Modulos generales
import sys
...
sys.path.append(r"") # Ruta a módulo fletApp.py


# Modulo propio de app de Flet
from fletApp import TextElement, Button, Rectangle, TextArea, PageManager, PopupMenu, RadioGroup, CheckBoxGroup  # type: ignore 
...
def app(page: ft.Page) -> None:
    ...
    label_doc = TextElement(value="Docentes", size=20, left=370, top=140, width=240, height=490, page=page, text_color=ft.Colors.WHITE, bg_color=None)   # Label que dice "Docentes"
